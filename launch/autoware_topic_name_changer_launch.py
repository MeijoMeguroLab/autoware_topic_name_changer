...
def generate_launch_description():
  ...
  twist_topic_name= LaunchConfiguration("twist_topic_name", default ="/can_twist")
  ...
  pub_twist_topic_name= LaunchConfiguration("pub_twist_topic_name", default ="/sensing/gnss/ublox/fix_velocity")
  ...
  autoware_topic_name_changer = launch_ros.actions.Node(package='autoware_topic_name_changer', executable='autoware_topic_name_changer', output='screen', parameters=[{"lidar_topic_name":lidar_topic_name},{"twist_topic_name":twist_topic_name},{"imu_topic_name":imu_topic_name},{"gnss_topic_name":gnss_topic_name},{"pub_lidar_topic_name":pub_lidar_topic_name},{"pub_twist_topic_name":pub_twist_topic_name},{"pub_imu_topic_name":pub_imu_topic_name},{"pub_gnss_topic_name":pub_gnss_topic_name}])
