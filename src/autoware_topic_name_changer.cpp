...
TopicNameChanger::TopicNameChanger(const rclcpp::NodeOption& node_options):Node("autoware_topic_name_changer",node_options){
  ...
  velodyne_points_sub_ = this->create_subscription<velodyne_msgs::msg::VelodyneScan>(params_.lidar_topic_name, qos, std::bind(&TopicNameChanger::velodyne_callback, this, std::placeholders::_1));
  ...
  velodyne_points_pub_ = this->create_publisher<velodyne_msgs::msg::VelodyneScan>( params_.lidar_topic_name, 10);
  imu_pub_ = this->create_publisher<sensor_msgs::msg::Imu>( params_.imu_topic_name, 10);
  gnss_pub_ = this->create_publisher<sensor_msgs::msg::NavSatFix>( params_.pub_gnss_topic_name, 10);
}

  void TopicNameChanger::velodyne_points_callback(const velodyne_msgs::msg::VelodyneScan::SharedPtr msg)
  {
    velodyne_points_sub_->publish(*msg);
  }
  void TopicNameChanger::imu_callback(const sensor_msgs::msg::Imu::SharedPtr msg)
  {
    imu_sub_->publish(*msg);
  }
